...
- (IBAction)importAction:(id)sender {
    [OCEther oc_inportMnemonics:self.mnemonicTextView.text pwd:self.pwdTF.text path:self.pathLabel.text block:^(NSString *address, NSString *keyStore, NSString *mnemonicPhrase, NSString *privateKey, NSString *publicKey, BOOL suc, HSWalletError error) {
