...
- (IBAction)pledgeBtnAction:(UIButton *)sender {
    ...
    [DCEther dc_pledgeActionNetworkWithArray:array privateKey:@"f759e9ba4112b0609b14e2e9d164b585084ea9e9c051b6782d416009b269cc02" noce:self.noce.text.intValue poundage:self.pundege block:^(BOOL isuc,id  _Nullable responseObject) {
        if (isuc) {
